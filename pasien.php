...
<td><?= $row['jk']; ?></td>
<td><?= $row['alamat']; ?></td>
<td><a href="editpasien.php?edit=<?= $row['idpasien']; ?>" class="btn btn-warning btn-sm">Edit</a> <a href="koneksi.php?idpsien=<?= $row['idpasien']; ?>" class="btn btn-danger btn-sm">Hapus</a></td>
</tr>
<?php } ?>
</table>
</div>
